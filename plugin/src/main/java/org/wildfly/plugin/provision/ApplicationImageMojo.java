...
public class ApplicationImageMojo extends PackageServerMojo {
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        try {
            ...
            boolean buildSuccess = buildApplicationImage(image, runtimeImage, serverDir, getDeploymentContent());
            if (!buildSuccess) {
    ...
    private boolean buildApplicationImage(String image, String runtimeImage, Path wildflyDirectory, Path deployment)
            throws IOException {
