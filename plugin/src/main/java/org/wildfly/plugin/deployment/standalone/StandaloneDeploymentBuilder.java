...
public class StandaloneDeploymentBuilder extends DeploymentBuilder<StandaloneDeploymentBuilder> {
     ...
     */
    public StandaloneDeploymentBuilder(final ModelControllerClient client) {
        super(client);
    }

    @Override
    protected Deployment doBuild() {
        return new StandaloneDeployment(client, getContent(), getName(), getRuntimeName(), getType(), getMatchPattern(), getMatchPatternStrategy());
    }

    @Override
    protected StandaloneDeploymentBuilder getThis() {
        return this;
    }
}
